#!/usr/bin/env bash
# Bisect cut 5 of 7: the clean image with upstream Python up to ded6c452c3.
#
...
#
#   cut 5: ded6c452c3 08-11 12:32 [Bugfix] Support HF-config compat for Inkling (#51850)
#
...
readonly PATCH=/configs/patches/k3-bisect-cut5.patch
...
# instead: ded6c452c3 08-11 12:32 [Bugfix] Support HF-config compat for Inkling (
