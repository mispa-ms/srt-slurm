#!/usr/bin/env bash
# Bisect cut 2 of 7: the clean image with upstream Python up to 6c95a641e9.
#
...
#
#   cut 2: 6c95a641e9 08-11 04:46 [2/N][Feat][Perf] Add new warmup infrastructure for JITs. Add predicate filtering for JIT warmup, and migrate Inkling FA4 (#49315)
#
...
readonly PATCH=/configs/patches/k3-bisect-cut2.patch
...
# instead: 6c95a641e9 08-11 04:46 [2/N][Feat][Perf] Add new warmup infrastructure
