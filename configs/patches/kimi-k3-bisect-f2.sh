#!/usr/bin/env bash
# Fine bisect 2 of 7: one commit added to the last clean point.
#
...
#
#   through: 52c70b210c 08-11 01:43 [XPU] [Linear] enable torch linear backend for blockwise  gem
#
...
readonly PATCH=/configs/patches/k3-bisect-f2.patch
