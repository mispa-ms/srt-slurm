#!/usr/bin/env bash
# Fine bisect 5 of 7: one commit added to the last clean point.
#
...
#
#   through: ce07118669 08-11 03:15 [Bugfix][Core] Preserve Mamba running CoW after external hits
#
...
readonly PATCH=/configs/patches/k3-bisect-f5.patch
