#!/usr/bin/env bash
# Bisect cut 3 of 7: the clean image with upstream Python up to 4988df2eb8.
#
...
#
#   cut 3: 4988df2eb8 08-11 08:09 [Config] Update default `_max_num_batched_tokens` from 8192 to 16384 (#51726)
#
...
readonly PATCH=/configs/patches/k3-bisect-cut3.patch
...
# instead: 4988df2eb8 08-11 08:09 [Config] Update default `_max_num_batched_token
