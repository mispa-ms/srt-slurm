#!/usr/bin/env bash
# c48 ns=4 baseline, plus vLLM PR #54168 only.
# =============================================================================
...
#
# Prices #54168 alone: the SM100 low-M fused latent-MoE decode tail. Merged
# 2026-08-28T17:45Z, about eleven hours after this image was built. We already run the
# fused tail (VLLM_ENABLE_K3_LATENT_MOE_TAIL_FUSION=1), so this changes its cost rather
...
bash /configs/patches/vllm-container-deps-k3-pr54168.sh
