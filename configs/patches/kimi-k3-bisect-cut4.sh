#!/usr/bin/env bash
# Bisect cut 4 of 7: the clean image with upstream Python up to e3fe212eaf.
#
...
#
#   cut 4: e3fe212eaf 08-11 09:13 [Bugfix] Generalize KV block zeroing to `AttentionSpec` (#51749)
#
...
readonly PATCH=/configs/patches/k3-bisect-cut4.patch
...
# instead: e3fe212eaf 08-11 09:13 [Bugfix] Generalize KV block zeroing to `Attent
