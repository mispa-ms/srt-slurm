#!/usr/bin/env bash
# c48 ns=4 baseline, plus #54168 and #54255.
# =============================================================================
...
#
# Both decode patches together. Interpretable only next to the two single-patch arms;
# they touch different things (MoE tail vs KDA spec path) so the expectation is
# additive, and a departure from additive is itself the finding.
#
