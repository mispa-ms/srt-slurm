...
readonly PATCH=/configs/patches/k3-cowstats-fix.patch
...
assert present is True, (
    ...
    f"needs it {'present' if True else 'absent'} -- the pair would compare "
    "a run to itself"
)
print("=== kimi-k3-nightly-v9-fix verified: counters on, #51766 present ===")
PYEOF
