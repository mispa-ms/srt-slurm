#!/usr/bin/env bash
# Round 4 of the vllm#51766 cost hunt: split the engine step. #51766 present.
#
...
readonly PATCH=/configs/patches/k3-stepsplit-fix.patch
...
assert present is True, (
    ...
    f"{'present' if True else 'absent'} -- the pair would compare a run to itself"
)
print("=== kimi-k3-nightly-v11-fix verified: step split on, #51766 present ===")
PYEOF
