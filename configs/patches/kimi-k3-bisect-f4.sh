#!/usr/bin/env bash
# Fine bisect 4 of 7: one commit added to the last clean point.
#
...
#
#   through: 490259c1f6 08-11 02:38 profiler: add PrivateUse1 activity support for custom backend
#
...
readonly PATCH=/configs/patches/k3-bisect-f4.patch
