#!/usr/bin/env bash
# c96 no-spec baseline, plus #51358 and #53598.
# =============================================================================
...
#
# c96 is where MI355X ATOM is strongest and our margin thinnest (+4.1% at their x 5.0), and where the measured Mooncake catch collapses to 8.8% against 58.2% at c32. Both remaining patches bear directly on that collapse.
#
