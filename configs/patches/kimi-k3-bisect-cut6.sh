#!/usr/bin/env bash
# Bisect cut 6 of 7: the clean image with upstream Python up to 0a94d85a66.
#
...
#
#   cut 6: 0a94d85a66 08-11 17:15 [Bugfix][MRV2] Require all requests to be decoding for uniform-decode dispatch (#51865)
#
...
readonly PATCH=/configs/patches/k3-bisect-cut6.patch
