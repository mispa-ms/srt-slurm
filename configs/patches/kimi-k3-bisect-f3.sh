#!/usr/bin/env bash
# Fine bisect 3 of 7: one commit added to the last clean point.
#
...
#
#   through: 3fb7bb46d6 08-11 02:23 [Perf] Avoid repeated multimodal prompt update scans (#51774)
#
...
readonly PATCH=/configs/patches/k3-bisect-f3.patch
