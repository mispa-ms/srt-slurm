#!/usr/bin/env bash
# Fine bisect 6 of 7: one commit added to the last clean point.
#
...
#
#   through: 0fec3d652b 08-11 03:22 [Bugfix][KV Offload] Centralize shared mmap cleanup in CPU wo
#
...
readonly PATCH=/configs/patches/k3-bisect-f6.patch
