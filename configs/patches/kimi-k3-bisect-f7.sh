#!/usr/bin/env bash
# Fine bisect 7 of 7: one commit added to the last clean point.
#
...
#
#   through: d8f840071e 08-11 03:35 [Model] Enable tower and connector LoRA for Keye (#51780)
#
...
readonly PATCH=/configs/patches/k3-bisect-f7.patch
